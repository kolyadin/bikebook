...
--
-- Table structure for table `ka_pic_history`
--

DROP TABLE IF EXISTS `ka_pic_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ka_pic_history` (
  `id_hash` varchar(32) NOT NULL,
  `source_file` varchar(250) NOT NULL,
  `timeCreate` datetime NOT NULL,
  `timeAccess` datetime NOT NULL,
...
--
-- Dumping data for table `ka_pic_history`
--

LOCK TABLES `ka_pic_history` WRITE;
/*!40000 ALTER TABLE `ka_pic_history` DISABLE KEYS */;
INSERT INTO `ka_pic_history` VALUES ('89baf1f15405cea7eef67209306d1b6c','/upload/d5/e0/a1/c.jpg','2013-02-27 16:59:36','2013-02-27 18:33:01','/k/6c0/58/b5/1664684879.jpg','{\"w\":120,\"z\":\"1\"}');
/*!40000 ALTER TABLE `ka_pic_history` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ka_user` VALUES (1,'2013-02-15 02:58:42','donflash@gmail.com','1987-02-13','man','',1,'$2a$11$arxTMzeYPABSBhdtDFwdAOu9w1nE3DfOL.VllKKmi37YFdu2iWXUS','sEVxaY5EBZ','5yA16Oiib6ptR12e)_vQm$(MZLJGvD@2_pte(zKd5KH-1rh7T8.Td7nZJlvJGr4u@p)@N6nGMneohacfrteW.Vzo.4bJbAr-jmfL2rEt#fRlSEV8L1RZluO3hFXlozIb'),(2,'2013-02-21 04:35:41','flash-boss@mail.ru','1987-02-13','man','',0,'$2a$11$h2FdGl6cnzkIksJ669nVkeEaQCXT7WPNGdsf/3ioZpuwj8py60PPi','uq8T-gwcTfU8#2','#y4g9pj(.MF@09mKyxpXZZw$.ZJTVlE6f95eXBD-R(U8#Qq)YUm$Qokls$!jAv9-z)!UNmo.SKuq$QnZ)w9jqNMRpskCQ9kYDl1t26q-@Sn5R4JpD(sOp1wjQsL)c-$zL_E');
...
INSERT INTO `ka_user_session` VALUES (1,1361481144,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.70 Safari/537.17'),(1,1361481367,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.70 Safari/537.17'),(1,1361481388,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.70 Safari/537.17'),(1,1361963792,'192.168.0.183','Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.22 (KHTML, like Gecko) Chrome/25.0.1364.97 Safari/537.22'),(1,1361971998,'192.168.0.183','Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.22 (KHTML, like Gecko) Chrome/25.0.1364.97 Safari/537.22'),(1,1361973324,'192.168.0.183','Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.22 (KHTML, like Gecko) Chrome/25.0.1364.97 Safari/537.22'),(1,1361973423,'192.168.0.183','Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.22 (KHTML, like Gecko) Chrome/25.0.1364.97 Safari/537.22'),(1,1361973435,'192.168.0.183','Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.22 (KHTML, like Gecko) Chrome/25.0.1364.97 Safari/537.22');
...
-- Dump completed on 2013-02-27 18:33:49
